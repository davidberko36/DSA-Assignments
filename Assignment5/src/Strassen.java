...
public class Strassen {
    ...
    public int[][] multiply(int[][] A, int[][] B) {
        ...
        if (n == 1)
            ...
            /** This joins 4 halves into one result matrix **/
            join(C11, R, 0 , 0);
            join(C12, R, 0 , n/2);
            join(C21, R, n/2, 0);
            join(C22, R, n/2, n/2);
    ...
    /** this function splits the parent matrix into child matrices **/
    ...
    /** this function then joins the child matrices into parent matrix **/
